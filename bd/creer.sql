...
(
    ...
    etablissement_pays        VARCHAR(255),
    etablissement_code_postal VARCHAR(10),
    etablissement_commune     VARCHAR(255),
    etablissement_departement VARCHAR(255),
    etablissement_latitude    FLOAT,
    etablissement_longitude   FLOAT,
    etablissement_distance    FLOAT
);
